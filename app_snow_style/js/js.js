...
let aProductos = [
  ...
  },
  {
    id: 7,
    categoria: "snowboard",
    nombre: "Fijaciones NX One",
    imagen: "img/fijaciones_NX.png",
    descripcion:
      "Fuero creadas especialmente para los amantes del freesyle.",
    precio: 21588,
  },
  {
    id: 8,
    categoria: "snowboard",
    nombre: " Fiaciones Cypress Surplus",
    imagen: "img/fijaciones_cyber.png",
    descripcion:
      "Diseño freeride para riders a quienes les gustan sus líneas un poco más ruidosas y sus áreas de juego más grandes.",
    precio: 57000,
  },
  {
    id: 9,
    categoria: "ski",
    nombre: "Fijaciones SPX 12",
    imagen: "img/fijaciones_ski.png",
    descripcion:
      "Las fijaciones de esquí Look SPX 12 son una opción fantástica para esquiadores intermedios y avanzados que buscan una excelente fijación.",
    precio: 32388,
  },
  {
    id: 10,
    categoria: "ski",
    nombre: "Campera DC Union",
    imagen: "img/campera_ski.png",
    descripcion:
      "Campera de esquí Union es una campera versátil inspirada en streetwear que cuenta con una capucha de lana extraíble y 40 gramos de aislamiento.",
    precio: 22788,
  },
  {
    id: 11,
    categoria: "accesorios",
    nombre: "Palas Voile Tele",
    imagen: "img/pala.png",
    descripcion:
      "La pala de avalancha Voilé Telepro es lo más parecido a un quitanieves. Está hecho para mover montañas de nieve.",
    precio: 15590,
  },
  {
    id: 12,
    categoria: "ski",
    nombre: "Burton Bullet Tool red",
    imagen: "img/destorni_burton.png",
    descripcion:
      "Destornillador Burton especial para ajustar fijaciones tanto de esquí y snowboard.",
    precio: 32388,
  },
];
...
function modalInfo() {
  ...
  divInfo.classList.add("modal1","position-fixed","d-flex","justify-content-center","flex-column","align-items-center");

  const divInfoDialog = d.createElement("div");
  divInfoDialog.classList.add("modal-dialog", "modal-md");
  divInfoDialog.setAttribute("role", "document");

  const divInfoConten = d.createElement("div");
  divInfoConten.classList.add("modal-content");

  const divInfoHeader = d.createElement("div");
  divInfoHeader.classList.add("modal-header");

  const h4Info = d.createElement("h4");
  h4Info.classList.add("h5","text-center");
  h4Info.innerText = "¡Desarrollado por:!";
  divInfoHeader.appendChild(h4Info);
  ...
  divInfoHeader.appendChild(divGraciasboton);
  divInfoConten.appendChild(divInfoHeader);

  const modalInfoBody = d.createElement("div");
  modalInfoBody.classList.add("modal-body","text-center");
  

  const ulLista = d.createElement("ul");
  ulLista.classList.add("list-group");
  

  const liListaimg=d.createElement("li");
  liListaimg.classList.add("list-group-item");
  const imglist=d.createElement("img");
  imglist.setAttribute("src", "img/yo.jpeg");
  imglist.classList.add("w-80");
  liListaimg.appendChild(imglist);

  ulLista.appendChild(liListaimg);

  const liLista = d.createElement("li");
  liLista.classList.add("list-group-item");
  const spanLista = d.createElement("span");
  spanLista.classList.add("font-weight-bold");
  liLista.innerText = "Nombre y aplledio:";
  spanLista.innerText = "Alexis Costedoat";
  liLista.appendChild(spanLista);
  ulLista.appendChild(liLista);

  const liLista2=d.createElement("li");
  liLista2.classList.add("list-group-item");
  const spanLista2=d.createElement("span");
  spanLista2.classList.add("font-weight-bold");
  spanLista2.innerText = "Diseño y programación Web";
  liLista2.innerText = "Carrera:";
  liLista2.appendChild(spanLista2);
  ulLista.appendChild(liLista2);

  const liLista3=d.createElement("li");
  liLista3.classList.add("list-group-item");
  const spanLista3=d.createElement("span");
  spanLista3.classList.add("font-weight-bold");
  spanLista3.innerText = "Interacción con Dispositivos Móviles";
  liLista3.innerText = "Materia:";
  liLista3.appendChild(spanLista3);
  ulLista.appendChild(liLista3);

  const liLista4=d.createElement("li");
  liLista4.classList.add("list-group-item");
  const spanLista4=d.createElement("span");
  spanLista4.classList.add("font-weight-bold");
  spanLista4.innerText ="Jonatan Grabriel Jorge" ;
  liLista4.innerText =  "Profesor:";
  liLista4.appendChild(spanLista4);
  ulLista.appendChild(liLista4);
  
  const liLista5=d.createElement("li");
  liLista5.classList.add("list-group-item");
  const spanLista5=d.createElement("span");
  spanLista5.classList.add("font-weight-bold");
  spanLista5.innerText ="Dwn2b" ;
  liLista5.innerText = "Comisión:";
  liLista5.appendChild(spanLista5);
  ulLista.appendChild(liLista5);
  
  const liLista6=d.createElement("li");
  liLista6.classList.add("list-group-item");
  const spanLista6=d.createElement("span");
  spanLista6.classList.add("font-weight-bold");
  spanLista6.innerText = "18/12/20";
  liLista6.innerText =  "Fecha del final:";
  liLista6.appendChild(spanLista6);
  ulLista.appendChild(liLista6);

  modalInfoBody.appendChild(ulLista);

  divInfoConten.appendChild(modalInfoBody);

  divInfoDialog.appendChild(divInfoConten);

  divInfo.appendChild(divInfoDialog);
...
function muchasGracias() {
  ...
  logoImg.setAttribute("src", "img/logomodal.png");
...
function formularioPago() {
  ...
  divFormFooter.classList.add("modal-footer","flex-column","flex-sm-row","justify-content-sm-between","align-items-sm-baseline");
  ...
  butFormCancel.classList.add("btn", "botun");
  butFormSeguir.classList.add("btn", "botun");
 butFormPagar.classList.add("btn", "botun");
...
function compraCarrito() {
  ...
  if (carrito.cantidadTotal === 0) {
    ...
    for (let i = 0; i < carrito.productos.length; i++) {
      ...
      botonQuitar.classList.add("cerrar","flex-row", "align-items-end", "pb-1","pb-sm-0","flex-sm-column" );
      ...
      botonQuitar.onclick = function borrarUno() {
        ...
        if (index != -1) {
          ...
          localStorage.carrito = JSON.stringify(carrito);
            ...
            if(carrito.cantidadTotal===0){
              divFootCarrito.remove();
              const noHayNada = d.createElement("p");
              noHayNada.classList.add("h4","text-center")
              noHayNada.innerText = "Su carrito está vacío.";
              modalBody.appendChild(noHayNada);
            }
      ...
      const butcruz=d.createElement("button");
      butcruz.classList.add( "botoncito");
     
      botonQuitar.appendChild(butcruz);
...
const columTd5 = d.createElement("td");
  ...
  divFootCarrito.classList.add("modal-footer","flex-column","flex-sm-row","justify-content-sm-between","align-items-sm-baseline");
  ...
  butVaciarCarrito.classList.add("btn" ,"botun");
  butFinCarrito.classList.add("btn" ,"botun");
  ...
  if (carrito.cantidadTotal === 0) {
    butVaciarCarrito.setAttribute("disabled", true);
   
  }
  butVaciarCarrito.onclick = function vaciar(){
    vaciarCarrito();
...
function mostrarModal(produ) {
  ...
  h3Modal.classList.add("text-center");
  ...
  pModal.classList.add("text-center");
  divModal.classList.add("text-center");
  ...
  descripcionModal.classList.add("text-center", "px-2");
...
function removerProductos(elemento) {
  while (elemento.firstChild) {
      elemento.removeChild(elemento.firstChild);
  }
}

function cargarProductos(tipo = false) {
  let productosFiltrados = [];

  if (tipo) {
   
    productosFiltrados = aProductos.filter(
      function(produ) {
        return produ.categoria == tipo;
      }
    );
  } else {
    
    productosFiltrados = aProductos;
  }

  const divProductos = d.getElementById("productos");
  
  removerProductos(divProductos);
  ...
  for (const producto of productosFiltrados) {
    ...
    botonAgregar.classList.add("btn","m-2");
...
let botonSnow = d.getElementById("snow");

botonSnow.onclick = function() {
  cargarProductos('snowboard');
}

let botinicio = d.getElementById("ini");
botinicio.onclick =  function inicio(){
  cargarProductos();
}

let botesqui= d.getElementById("esqui");
botesqui.onclick =  function esqui(){
  cargarProductos('ski');
}

let botaccesorios= d.getElementById("accesorios");
botaccesorios.onclick =  function accesorios(){
  cargarProductos('accesorios');
}

const botonInfo = d.getElementById("info");
botonInfo.onclick = function mostrarinfo(){
  modalInfo();
}
